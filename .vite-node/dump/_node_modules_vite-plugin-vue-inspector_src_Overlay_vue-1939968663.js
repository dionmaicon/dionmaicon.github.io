...
const __vite_ssr_import_0__ = await __vite_ssr_import__("/@id/virtual:vue-inspector-options", {"importedNames":["default"]});const __vite_ssr_import_1__ = await __vite_ssr_import__("vue", {"importedNames":["mergeProps"]});const __vite_ssr_import_2__ = await __vite_ssr_import__("vue/server-renderer", {"importedNames":["ssrRenderAttr","ssrRenderStyle","ssrRenderClass","ssrRenderAttrs","ssrInterpolate"]});const __vite_ssr_import_3__ = await __vite_ssr_import__("/node_modules/vite-plugin-vue-inspector/src/Overlay.vue?vue&type=style&index=0&scoped=31d1379f&lang.css");const __vite_ssr_import_4__ = await __vite_ssr_import__("vue", {"importedNames":["useSSRContext"]});const __vite_ssr_import_5__ = await __vite_ssr_import__("/@id/__x00__plugin-vue:export-helper", {"importedNames":["default"]});
const base = __vite_ssr_import_0__.default.base;
...
const _sfc_main = {
  ...
  data() {
    return {
      containerRef: null,
      floatsRef: null,
      enabled: __vite_ssr_import_0__.default.enabled,
      toggleCombo: __vite_ssr_import_0__.default.toggleComboKey?.toLowerCase?.()?.split?.("-") ?? false,
      disableInspectorOnEditorOpen: __vite_ssr_import_0__.default.disableInspectorOnEditorOpen,
      ...
      KEY_IGNORE,
      animation: !__vite_ssr_import_0__.default.reduceMotion
    };
  },
  computed: {
    logoColors() {
    ...
    containerVisible() {
      const { toggleButtonVisibility } = __vite_ssr_import_0__.default;
      return toggleButtonVisibility === "always" || toggleButtonVisibility === "active" && this.enabled;
    },
    containerPosition() {
      return __vite_ssr_import_0__.default.toggleButtonPos.split("-").map((p) => `${p}: 15px;`).join("");
    },
    bannerPosition() {
      const [x, y] = __vite_ssr_import_0__.default.toggleButtonPos.split("-");
      return {
    ...
    floatsStyle() {
      ...
      x = Math.max(margin, x);
      x = Math.min(x, (void 0).innerWidth - floatsWidth - margin);
      if (x < floatsWidth / 2) {
        x = floatsWidth / 2 + margin;
      };
      y = Math.max(margin, y);
      y = Math.min(y, (void 0).innerHeight - floatsHeight - margin);
      return {
        left: `${x}px`,
        top: `${y}px`
      };
  ...
  mounted() {
    this.toggleCombo && (void 0).body.addEventListener("keydown", this.onKeydown);
    this.toggleEventListener();
    (void 0).__VUE_INSPECTOR__ = this;
  },
  methods: {
    toggleEventListener() {
      const listener = this.enabled ? (void 0).body.addEventListener : (void 0).body.removeEventListener;
      listener?.call((void 0).body, "mousemove", this.updateLinkParams);
      listener?.call((void 0).body, "resize", this.closeOverlay, true);
      listener?.call((void 0).body, "click", this.handleClick, true);
    },
    toggleEnabled() {
    ...
    onKeydown(event) {
      if (event.repeat || event.key === void 0)
        return;
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = (0,__vite_ssr_import_4__.useSSRContext)();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/vite-plugin-vue-inspector/src/Overlay.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

__vite_ssr_exports__.default = /* @__PURE__ */ (0,__vite_ssr_import_5__.default)(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-31d1379f"], ["__file", "/media/dd/Data/Projects/dionmaicon.github.io/node_modules/vite-plugin-vue-inspector/src/Overlay.vue"]]);
